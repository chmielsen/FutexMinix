...
/* Futex */
#define IPC_FUTINIT (IPC_BASE+8)
#define IPC_FUTDESTROY (IPC_BASE+9)
#define IPC_FUTLOCKADD (IPC_BASE+10)
#define IPC_FUTUNLOCKWAKE (IPC_BASE+11)
#   define FUTEX_ID     m9_l1
#   define FUTEX_VALADR m9_l2
